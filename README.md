...
- 📊 **Observability**: Implementing monitoring solutions with Prometheus, Grafana, ELK Stack
- 🔒 **Security**: Integrating security scanning (Cycode, WIZ), encryption (GPG), and RBAC

---

### 💼 Current Focus

- Working on **data security & compliance** projects with Azure, Databricks, and Terraform
- Implementing **Infrastructure as Code** using Terraform, CDK, and CloudFormation
- Building **event-driven data pipelines** with automated encryption and compliance controls
- Leading **cloud migration** initiatives and disaster recovery strategies
...
![CDK](https://img.shields.io/badge/CDK-FF9900?style=flat&logo=amazon-aws&logoColor=white)
